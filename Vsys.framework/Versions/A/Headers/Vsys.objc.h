// Objective-C API for talking to walkwallet-lib Go package.
//   gobind -lang=objc walkwallet-lib
//
...
// skipped field Contract.Textual with unsupported type: walkwallet-lib.Textual

// skipped field Contract.Functions with unsupported type: []walkwallet-lib.Func
 ...
 * used in client
 */
FOUNDATION_EXPORT NSString* _Nonnull const VsysConstContractNonFungibleToken;
/**
 * used in client
 */
 ...
 * contract type
 */
FOUNDATION_EXPORT NSString* _Nonnull const VsysContractTypeDefault;
/**
 * contract type
 */
FOUNDATION_EXPORT NSString* _Nonnull const VsysContractTypeNft;
/**
 * contract type
 */
FOUNDATION_EXPORT NSString* _Nonnull const VsysContractTypeSplit;
/**
 * contract type
 */
FOUNDATION_EXPORT NSString* _Nonnull const VsysContractTypeSystem;
